<template>
  ...
  >
    ...
    <button type="button" class="btn btn-outline-warning mt-3" @click="resetShowed = !resetShowed">
      忘记密码?
    </button>
  </form>
  ...
  >
    <div class="input-group has-validation mt-1 mb-1">
      <span class="input-group-text"><font-awesome-icon icon="fa-solid fa-envelope" flip /></span>
      <div class="form-floating">
        <input
          type="text"
          class="form-control"
